...
更新日: 2026-09-02
フェーズ: β版中心体験・内部レビュー反映完成 — `PLAN.md` B1〜B12を達成
...
- ロードマップ管理: 閲覧用`/roadmaps/:id`と管理用`/admin/roadmaps/:id`を分離。タイトル、概要、対象、公開状態、複数段階、各段階の講習会順を共通`RoadmapInput`で作成・編集し、削除できる。下書きは学習者向け一覧/詳細に出さない。
