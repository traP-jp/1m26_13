...
更新日: 2026-09-02
フェーズ: β版中心体験・内部レビュー反映完成 — `PLAN.md` B1〜B17を達成
...
- プロフィール: バッジ、完了した講習会、ロードマップを下線型の3タブで表示。basiQ-uiにTabsがないためnativeのARIA tabをbasiQ tokenで最小実装し、選択/対応関係と左右矢印・Home・Endのキーボード移動を備える。
