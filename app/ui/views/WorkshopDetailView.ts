...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { workshop, loading, busy, error, notice, managePreview, groups, simple, visibleGroup, primaryOccurrence, selectedRound, selectRound, toggleCompletion, load, formatDate, kindLabel };
  },
  template: `
